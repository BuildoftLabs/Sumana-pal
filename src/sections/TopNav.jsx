    ...
    <header className={`top-nav${isScrolled ? " is-scrolled" : ""}`} aria-label="Main navigation">
      ...
      <nav className={`nav-menu${isOpen ? " is-open" : ""}`} aria-label="Primary">
        ...
        <div className="nav-social" aria-label="Social links">
          <a className="nav-social-link" href="https://www.instagram.com/dietitian_sumana.pal" target="_blank" rel="noreferrer" aria-label="Instagram">
          ...
          <a className="nav-social-link" href="https://wa.me/919804380329" target="_blank" rel="noreferrer" aria-label="WhatsApp">
            <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
              <path
